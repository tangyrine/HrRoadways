  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center z-50 bg-black bg-opacity-50">
      <div className="bg-white rounded-2xl shadow-lg w-full max-w-md p-6 relative">
        ...
        <h2 className="text-xl font-semibold mb-4 text-neutral-900 text-center">Register</h2>
        ...
        <p className="flex justify-center items-center text-neutral-900 gap-2 mt-2.5">
            already have an account? <span className="text-blue-600 cursor-pointer hover:underline" onClick={()=>{openModal('login')}}>Login</span>
        </p>
      </div>   
    </div>
  );
